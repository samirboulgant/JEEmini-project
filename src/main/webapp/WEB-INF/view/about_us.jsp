	...
	<div class="pt-24">
		<div
			...
			<div
				...
				<p class="leading-normal text-2xl mb-8 text-center">Brikol.ma est un site conçu spécialement pour vous aider à trouver des artisans de qualité et confiance facilement!</p>
				<p class="leading-normal text-2xl mb-8 text-center">Notre équipe de développeurs assure à tout moment la bonne qualité du site et un bon fonctionnement de ses composantes.</p>
				<p class="leading-normal text-2xl mb-8 text-center">Par passion et par persévérance, nous avons pu créé Brikol qui vous offre plusieurs artisants à votre disposition le moment où vous en avez besoin! </p>
			</div>
			<!--Right Col-->
		</div>
	</div>
		...
		<div class="container max-w-5xl mx-auto m-8">
			...
			<div
				...
				<div
					...
					<div class="w-full h-60 categories-container">
						<img class="object-center object-cover w-full h-full filter-cat"
							src="IMAGES/perseverance.jpg" alt="Persévérance">
						<div class="categories-text">Persévérance</div>
					</div>
				</div>
				<div
					class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col h-60 md:flex-row">
				...
				<div
					...
					<div class="w-full h-60 categories-container">
						<img class="object-center object-cover w-full h-full filter-cat"
							src="IMAGES/competence.png" alt="Compétence">
						<div class="categories-text">Compétence</div>
					</div>
				</div>
				<div
					class="w-full bg-white rounded-lg sahdow-lg overflow-hidden flex flex-col h-60 md:flex-row">
